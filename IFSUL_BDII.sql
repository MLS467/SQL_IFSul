...
tipo_cliente char(1),
check (tipo_cliente='F' OR tipo_cliente='J'),
rg char(15),
cpf char(15),
cnpj char(14),
obs text,
primary key (codcliente));
create table fones_clientes( cliente integer not null,
num_telefone char(10),
PRIMARY KEY (cliente, num_telefone),
FOREIGN KEY (cliente) REFERENCES clientes(codcliente));
create table funcionarios( codfunc integer,
nome varchar(50) not null,
endereco varchar(50) not null,
...
primary key (codfunc));
create table ordens_servico( numero integer,
data date,
...
create table vendas( codigo integer,
...
create table contas_receber ( cod integer primary key,
...
create table itens ( codigo integer,
valor numeric (10,2) not null,
...
estoque real,
primary key (codigo));
create table venda_itens ( sequencial integer,
codvenda integer,
codigo integer,
quantidade real,
valor numeric (10,2),
...
create table ordens_itens( sequencial serial,
...
foreign key (numero) references ordens_servico(numero),
foreign key (codigo) references itens (codigo));
create table fornecedores( codigo integer not null,
descricao varchar(100),
endereco varchar(50),
contato varchar(50),
cnpj varchar(14) unique,
primary key (codigo));
create table compras( codigo integer not null,
...
create table compras_itens( sequencial serial not null,
...
create table contas_pagar( numero integer not null,
...
create table despesas (codigo integer,
descricao varchar(50),
primary key (codigo));
alter table contas_pagar add constraint despesas_fkey foreign key (despesas) references
despesas(codigo);


insert into clientes (codcliente, nome, endereco, tipo_cliente, obs)
values (100, 'José da Silva', 'Av. Bento Gonçalves', 'F', 'xyz');
insert into clientes (codcliente, nome, endereco, tipo_cliente, obs)
values (101, 'Maria Silveira', 'Tiradentes', 'F', 'xxx');
insert into clientes (codcliente, nome, endereco, tipo_cliente, obs)
values (102, 'Roberto Pereira', 'Dom Pedro II', 'F', 'xyz');
insert into clientes (codcliente, nome, endereco, tipo_cliente, obs)
values (103, 'Valéria Ferreira', 'Av. Bento Gonçalves', 'F', 'yyy');
insert into clientes (codcliente, nome, endereco, tipo_cliente, obs)
values (104, 'Atacado Martins', 'General Osório', 'J', 'xyz');
insert into clientes (codcliente, nome, endereco, tipo_cliente, obs)
values (105, 'Mercado Silveira', 'Gomes Carneiro', 'J', 'xxx');
insert into clientes (codcliente, nome, endereco, tipo_cliente, obs)
values (106, 'Isabela Medeiros', 'Av. Carlos Monteiro', 'F', 'xyz');
...
values (200, 'José da Silveira', 'Marechal Deodoro', 81754656200, 3);
insert into funcionarios (codfunc, nome, endereco, cpf, tipo)
values (201, 'Mariana Costa', 'José Bonifácio', 77486491460, 2);
insert into funcionarios (codfunc, nome, endereco, cpf, tipo)
values (202, 'Marcia Gonçalves', 'Av. Ferreira Viana', 55684414729, 2);
insert into funcionarios (codfunc, nome, endereco, cpf, tipo)
values (203, 'Sergio Pires', 'José Bonifácio', 87162502300, 1);
insert into funcionarios (codfunc, nome, endereco, cpf, tipo)
values (204, 'Cristian Tavares', 'Av. 25 de julho', 33817362641, 3);
insert into funcionarios (codfunc, nome, endereco, cpf, tipo)
values (205, 'Mateus Santos', 'Gonçalves Chaves', 52564250645, 1);
insert into funcionarios (codfunc, nome, endereco, cpf, tipo)
values (206, 'Fabiano Nobre', 'Av. Dom Joaquim', 30212787365, 3);
...
insert into contas_receber (cod, data_lancamento, data_vencimento, valor, data_pagamento,
valor_pagamento, codigo_vendas)
values (300, '2020/05/13', '2020/05/30', 1000, '2020/05/29', 1000, 01);
insert into contas_receber (cod, data_lancamento, data_vencimento, valor, data_pagamento,
valor_pagamento, codigo_vendas)
values (301, '2020/09/14', '2020/09/29', 2500, '2020/09/28', 2000, 02);
insert into contas_receber (cod, data_lancamento, data_vencimento, valor, data_pagamento,
valor_pagamento, codigo_vendas)
values (302, '2020/10/23', '2020/10/26', 1200, '2020/10/26', 1200, 03);
insert into contas_receber (cod, data_lancamento, data_vencimento, valor, data_pagamento,
valor_pagamento, codigo_vendas)
values (303, '2020/01/23', '2020/01/30', 3000, '2020/01/29', 3000, 04);
insert into contas_receber (cod, data_lancamento, data_vencimento, valor, data_pagamento,
valor_pagamento, codigo_vendas)
values (305, '2020/03/02', '2020/03/10', 2700, '2020/03/10', 2700, 05);
insert into contas_receber (cod, data_lancamento, data_vencimento, valor, data_pagamento,
valor_pagamento, codigo_vendas)
values (306, '2020/05/16', '2020/05/30', 5000, '2020/05/29', 5000, 06);
insert into contas_receber (cod, data_lancamento, data_vencimento, valor, codigo_vendas)
...
insert into itens (codigo, valor, custo, descricao, tipo,estoque) values (07,1800 , 1450,
'centrífuga de bancada com rotor velocidade 0-4000RPM K14-4000', 'p', 500);
insert into itens (codigo, valor, custo, descricao, tipo,estoque)
...
insert into ordens_itens (sequencial, numero, codigo, quantidade, valor, valor_total)
...
values (01, 'Bento e Cia', 'Dom Pedro II', 32254896, 83848582000198);
insert into fornecedores (codigo, descricao, endereco, contato, cnpj)
values (02, 'Mendes Araújo', 'Av. Dom Joaquim', 32275692, 52236265000197);
insert into fornecedores (codigo, descricao, endereco, contato, cnpj)
values (03, 'Bezerra Júnior', 'Av. Fernando Osório', 32226578, 75112555000124);
insert into fornecedores (codigo, descricao, endereco, contato, cnpj)
values (04, 'Fonseca Ltda.', 'Praça XX de setembro', 32273370, 46631334000164);
insert into fornecedores (codigo, descricao, endereco, contato, cnpj)
values (05, 'Joaquim e Cia', 'Av. Duque de Caxias', 32227343, 820824420001-99);
insert into fornecedores (codigo, descricao, endereco, contato, cnpj)
values (06, 'Barroso e Barroso', 'General Osório', 32296548, 45995532000144);
insert into fornecedores (codigo, descricao, endereco, contato, cnpj)
values (07, 'Padilha Ltda.', 'Marechal Deodoro', 32252571, 098467580001-10);
insert into fornecedores (codigo, descricao, endereco, contato, cnpj)
values (08, 'JJ e Cia.', 'Dom Pedro II', 32258691, 22065998000145);
insert into compras (codigo, codfornecedor, data, valor_total, numero_nota)
...
insert into compras_itens (sequencial, codcompra, coditem, quantidade, valor, valor_total)
...
values (01, 2354, 1, '2016/05/15', '2016/05/15', 5000, 5000, '2016/05/10', 100);
insert into contas_pagar (numero, num_boleto, tipo, data_vencimento, data_pagamento,
valor_pago, valor, data_lancamento, compra)
values (02, 2664, 1, '2017/02/22', '2017/02/22', 5750, 5750, '2017/02/18', 103);
insert into contas_pagar (numero, num_boleto, tipo, data_vencimento, data_pagamento,
valor_pago, valor, data_lancamento, compra)
values (03, 2354, 1, '2017/10/15', '2017/10/15', 6000, 6000, '2016/09/30', 105);
insert into contas_pagar (numero, num_boleto, tipo, data_vencimento, data_pagamento,
valor_pago, valor, data_lancamento, compra)
values (04, 5689, 1, '2017/11/23', '2017/11/23', 2000, 2000, '2017/11/17', 106);
insert into contas_pagar (numero, num_boleto, tipo, data_vencimento, data_pagamento,
valor_pago, valor, data_lancamento, compra)
values (05, 1458, 1, '2017/12/25', '2017/12/25', 2500, 2500, '2017/12/22', 107);
insert into contas_pagar (numero, num_boleto, tipo, data_vencimento, data_pagamento,
valor_pago, valor, data_lancamento, compra)
values (06, 6985, 1, '2017/09/26', '2017/09/26', 7500, 7500, '2016/09/16', 101);
insert into contas_pagar (numero, num_boleto, tipo, data_vencimento, data_pagamento,
valor_pago, valor, data_lancamento, compra)
values (07, 7584, 2, '2016/05/27', '2016/05/27', 20000, 20000, '2017/12/23', 102);
insert into contas_pagar (numero, num_boleto, tipo, data_vencimento, data_pagamento,
valor_pago, valor, data_lancamento, compra)
...
insert into despesas (codigo, descricao)
values (08, 'seguraça');
insert into clientes (codcliente, nome, endereco, tipo_cliente, obs) values (107, 'Mariana Amaral', 'Rua das Orquídeas, 134', 'F', 'xyz');
